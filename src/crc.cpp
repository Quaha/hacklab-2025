// THANKS TO https://create.stephan-brumme.com/crc32/#slicing-by-16-overview
...
static const uint32_t Crc32Lookup[16][256] = {
    // note: the first number of every second row corresponds to the half-byte
    // look-up table !
    {
...
Status crc32(const uint8_t* data, size_t data_len, uint32_t* result) {
  *result = crc32_16bytes_prefetch(data, data_len, 0, 1024);
  return STATUS_OK;
}
